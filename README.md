...
Depending on the user's target system, the **ImageList** class may fail to load images from **.svg** image files. This issue is an indication that the **CairoSVG** package and its dependencies may require additional tools for its installation. The user should refer to the **CairoSVG** package documentation available at [CairoSVG Documentation](https://cairosvg.org/documentation) and  [GitHub: Kozea/CairoSVG/issues](https://github.com/Kozea/CairoSVG/issues) for help in resolving this issue.
